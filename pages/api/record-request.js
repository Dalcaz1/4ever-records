            ...
            checkout_options:
              {
                ...
                redirect_url:
                  'https://www.4evermemoriesrecordstore.com/success',
    ...
    try {
        ...
        cart
          .map(item => {
            ...
            <div style="padding:12px;border-bottom:1px solid #2a2a2a;">
              <div style="color:#e8d5b0;font-size:16px;font-weight:700;">
                ${
                  item.title ||
                  item.t
                }
              ...
              <div style="color:#4ade80;margin-top:4px;">
                $${parseFloat(
                  item.price ||
                    item.p
                ).toFixed(2)}
              ...
              <div style="color:#c9a84c;margin-top:4px;">
                Condition:
                ${
                  item.condition ||
                  item.c ||
      ...
      await fetch(
        'https://api.resend.com/emails',
        {
          ...
          body: JSON.stringify({
            from:
              'orders@4evermemoriesrecordstore.com',
            ...
            html:
              ...
              '<div style="color:#e8d5b0;font-weight:700;font-size:18px;">' +
              form.name +
              '</div>' +
              ...
              '<div style="margin-top:20px;padding-top:20px;border-top:1px solid #2a2a2a;color:#fff;font-size:20px;font-weight:700;">' +
      ...
      await fetch(
        'https://api.resend.com/emails',
        {
          ...
          body: JSON.stringify({
            ...
            subject:
              '🎵 Thank You For Your Order - 4 Ever Memories',
            ...
            html:
              ...
              '<div style="font-size:22px;color:#c9a84c;font-weight:700;">🎵 Thank You For Your Order!</div>' +

              '</div>' +

              '<div style="padding:32px;color:#e8d5b0;font-size:16px;line-height:1.7;">' +

              '<p>Hi ' +
              form.name +
              ',</p>' +

              '<p>Thank you for shopping with 4 Ever Memories Record Store.</p>' +

              '<p>Your order has been received and is now being prepared for shipment.</p>' +
              ...
              '<p style="margin-top:30px;color:#c9a84c;">4 Ever Memories Record Store</p>' +
